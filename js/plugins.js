...
(function ($) {
  ...
  var methods = {
      ...
      return this.each(function () {
        ...
        if (config.sortOnLoad) {
          ...
          if ($.isArray(config.sortOnLoad)) {
            ...
            $(
              config.sortSelector + "[data-sort=" + config.sortOnLoad + "]"
            ).addClass("active");
        ...
        for (var i = 0; i < 2; i++) {
          ...
          config.transition[a + "transition"] =
            "all " + config.transitionSpeed + "ms ease-in-out";
          config.perspective[a + "perspective"] =
            config.perspectiveDistance + "px";
          config.perspective[a + "perspective-origin"] =
        ...
        $.each(showOnLoadArray, function () {
          $(config.filterSelector + '[data-filter="' + this + '"]').addClass(
            "active"
          );
        });
        ...
        var delay = setTimeout(function () {
          ...
          var reset = setTimeout(function () {
            if (config.layoutMode == "list") {
              $showOnLoad
                .removeStyle(config.prefix + "transition, transition")
                .css({
        ...
        $(config.filterSelector).bind(config.buttonEvent, function () {
          if (!config.mixing) {
            ...
            if (config.multiFilter == false) {
              ...
              $(
                config.filterSelector + '[data-filter="' + config.filter + '"]'
              ).addClass("active");
            } else {
    ...
    filter: function (arg) {
      return this.each(function () {
        ...
        if (!config.mixing) {
          $(config.filterSelector).removeClass("active");
          $(config.filterSelector + '[data-filter="' + arg + '"]').addClass(
            "active"
          );
      ...
      return this.each(function () {
        ...
        if (!config.mixing) {
          ...
          if ($.isArray(args)) {
            ...
            $(config.sortSelector + '[data-sort="' + args + '"]').addClass(
              "active"
            );
            var sortby = args,
              order = "desc";
      ...
      return this.each(function () {
        ...
        if (!config.mixing) {
          $(config.filterSelector)
            .add(config.sortSelector)
            .removeClass("active");
          $(
            config.filterSelector + '[data-filter="' + multiOut.filter + '"]'
          ).addClass("active");
  ...
  function goMix(filter, sortby, order, $cont, config) {
    ...
    var effectsOut =
      config.layoutMode == "list" && config.listEffects != null
        ? config.listEffects
        : config.effects;
    ...
    if (Array.prototype.indexOf) {
      ...
      config.rotateZ =
        effectsOut.indexOf("rotateZ") > -1 ? "rotate(180deg)" : "";
      config.rotateY =
        effectsOut.indexOf("rotateY") > -1 ? "rotateY(90deg)" : "";
      config.rotateX =
        effectsOut.indexOf("rotateX") > -1 ? "rotateX(90deg)" : "";
      config.blur = effectsOut.indexOf("blur") > -1 ? "blur(8px)" : "";
      config.grayscale =
        effectsOut.indexOf("grayscale") > -1 ? "grayscale(100%)" : "";
    }
    ...
    if (config.filterLogic == "or") {
      ...
      $hide = $hide.add(
        $par.find(mixSelector + ":not(." + filterArray.join(".") + "):visible")
      );
    }
    ...
    if (
      $show.filter(":visible").length == total &&
      !$tohide.length &&
      !sortby
    ) {
    ...
    if ($show.length) {
      ...
      $pre.each(function () {
        ...
        for (var i = 0; i < 2; i++) {
          var a = i == 0 ? (a = config.prefix) : "";
          preCSS[a + "transform"] =
            "translate(" + data.preTX + "px," + data.preTY + "px)";
        }
      ...
      var delay = setTimeout(function () {
        ...
        $toshow.each(function () {
          ...
          for (var i = 0; i < 2; i++) {
            var a = i == 0 ? (a = config.prefix) : "";
            toShowCSS[a + "transition-property"] =
              a + "transform, " + a + "filter, opacity";
            toShowCSS[a + "transition-timing-function"] =
              config.easing + ", linear, linear";
            toShowCSS[a + "transition-duration"] = speed + "ms";
            toShowCSS[a + "transition-delay"] = "0";
            toShowCSS[a + "transform"] =
              "translate(" + data.tX + "px," + data.tY + "px)";
          ...
          $(this)
            .css(
              "-webkit-transition",
              "all " + speed + "ms " + config.easingFallback
            )
            .css(toShowCSS);
        });
        ...
        $pre.each(function () {
          var data = this.data;
          data.tX =
            data.finalPrePos.left != 0
              ? data.finalPrePos.left - data.preInterPos.left
              : 0;
          data.tY =
            data.finalPrePos.left != 0
              ? data.finalPrePos.top - data.preInterPos.top
              : 0;
      ...
      var delay = setTimeout(function () {
        ...
        if (config.resizeContainer) {
          ...
          for (var i = 0; i < 2; i++) {
            var a = i == 0 ? (a = config.prefix) : "";
            containerCSS[a + "transition"] =
              "height " + speed + "ms ease-in-out";
  ...
  function sort(sortby, order, $cont, config) {
    ...
    function compare(a, b) {
      var sortAttrA = isNaN(a.attr(sortby) * 1)
          ? a.attr(sortby).toLowerCase()
          : a.attr(sortby) * 1,
        sortAttrB = isNaN(b.attr(sortby) * 1)
          ? b.attr(sortby).toLowerCase()
          : b.attr(sortby) * 1;
